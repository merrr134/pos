...
@section('content')
    ...
    <div class="hero-header mb-6">
        ...
        <h2 class="font-display text-2xl font-bold">Edit User</h2>
        <p class="mt-1 text-sm text-white/80">Perbarui data, role, atau status akun <span class="font-semibold">{{ $user->name }}</span>.</p>
    </div>
